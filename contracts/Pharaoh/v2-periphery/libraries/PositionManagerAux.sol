...
library PositionManagerAux {
    ...
    /// @param oldVeNftTokenId The identifier of the previous veNFT to which the NFP was attached.
    /// @param newVeNftTokenId The identifier of the new veNFT to which the NFP was attached.
    event SwitchAttachment(
        uint256 indexed tokenId,
        uint256 oldVeNftTokenId,
        uint256 newVeNftTokenId
    );
    ...
    function decreaseLiquidity(
        ...
        // veNFT would've been detached if liquidity reaches 0
        if (positionLiquidity - params.liquidity == 0) {
            emit SwitchAttachment(params.tokenId, position.veTokenId, 0);
