...
import {QiDelegatorInterface, QiErc20Interface, QiTokenInterface} from "./Comptroller/QiTokenInterfaces.sol";
import "./Comptroller/ComptrollerInterface.sol";
import "./Comptroller/EIP20NonStandardInterface.sol";
 ...
 * @author Benqi
 */
contract QiErc20Delegator is
    QiTokenInterface,
    QiErc20Interface,
    QiDelegatorInterface
{
    /**
    ...
    function _setImplementation(
        ...
        require(
            msg.sender == admin,
            "QiErc20Delegator::_setImplementation: Caller must be admin"
        );
    ...
    function() external payable {
        require(
            msg.value == 0,
            "QiErc20Delegator:fallback: cannot send value to fallback"
        );
