...
abstract contract QiToken is QiTokenInterface, Exponential, TokenErrorReporter {
    ...
    function mintFresh(
         ...
         *  Note: The qiToken must handle variations between ERC-20 and ETH underlying.
    ...
    function liquidateBorrowFresh(
        ...
        require(
            qiTokenCollateral.balanceOf(borrower) >= seizeTokens,
        ...
        if (address(qiTokenCollateral) == address(this)) {
            ...
            seizeError = qiTokenCollateral.seize(
                liquidator,
                borrower,
                seizeTokens
            );
