...
interface ILimitOrderManager {
    ...
    function getCurrentAmounts(
        ...
        external
        view
        returns (uint256 amountX, uint256 amountY, uint256 feeX, uint256 feeY);
    ...
    function placeOrder(
        ...
        uint24 binId,
        uint256 amount
    ) external payable returns (bool orderPlaced, uint256 orderPositionId);
    ...
    function executeOrders(
        ...
        OrderType orderType,
        uint24 binId
    ) external returns (bool orderExecuted, uint256 positionId);
