...
import "@oz-4.9.0/access/Ownable.sol";
...
contract PangolinRouterSupportingFees is
    IPangolinRouterSupportingFees,
    Ownable
{
    ...
    function swapTokensForExactTokens(
        ...
        amounts = PangolinLibrary8.getAmountsIn(
            FACTORY,
    ...
    function swapExactAVAXForTokens(
        ...
        assert(
            IWAVAX(WAVAX).transfer(
                PangolinLibrary8.pairFor(FACTORY, WAVAX, path[1]),
                msg.value
            )
        );
